        ...
        $.ajax({
            ...
            {                                                
                ...
                for (i = 0; i<data.total_data; i++){
                    ...
                    +        '<button type="button" class="btn btn-edit" data-toggle="modal" data-target="#myModalUpdate'+txt_id[i]+'"  data-dismiss="modal">Editar</button>'
                    +        '<button type="button" class="btn btn-delete" data-toggle="modal" data-target="#myModalDelete'+txt_id[i]+'"  data-dismiss="modal">Eliminar</button>'                            
                    +   '</div>'
                    +'</div>'
                    ...
                    $(".modal-update").append('<div class="modal fade" id="myModalUpdate'+txt_id[i]+'" role="dialog">'
                    +'<div class="modal-dialog">'                                        
                    +'<div class="modal-content">'
                    +   '<div class="modal-header">'
                    +       '<button type="button" class="close" data-dismiss="modal">&times;</button>'
                    ...
                    +       '<input id="tipoid" type="text" value="'+txt_tipo[i]+'" class="form-control" name="tipoid" required >'
                    +  '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="identificacion"># de identificación</label>'
                    +    '<input id="identificacion" type="text" value="'+txt_numero[i]+'" class="form-control" name="identificacion" required>'
                    +  '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="nombre">Nombres:</label>'
                    +    '<input id="nombre" type="text" value="'+txt_nombre[i]+'" class="form-control" name="nombre" required>'
                    + '</div>'
                    + '<div class="form-group label">'
                    +   '<label for="departamento">Departamento:</label>'
                    +    '<input id="departamento" type="text" value="'+txt_departamento[i]+'" class="form-control" name="departamento" required>'
                    + '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="ciudad">Ciudad:</label>'
                    +    '<input id="ciudad" type="text" value="'+txt_ciudad[i]+'" class="form-control" name="ciudad" required>'
                    + '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="servicio">Servicio:</label>'
                    +    '<input id="servicio" type="text" value="'+txt_agrupador[i]+'" class="form-control" name="servicio" required>'
                    + '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="especialidad">Especialidad:</label>'
                    +    '<input id="especialidad" type="text" value="'+txt_especialidad[i]+'" class="form-control" name="especialidad" required>'
                    + '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="direcciones">Direcciones:</label>'
                    +    '<input id="direcciones" type="text" value="'+txt_direccion[i]+'" class="form-control" name="direcciones" required>'
                    + '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="telefono">Teléfono o celular</label>'
                    +    '<input id="telefono" type="text" value="'+txt_telefono[i]+'" class="form-control" name="telefono" required>'
                    + '</div>'
                    + '<div class="form-group label">'
                    +    '<label for="aliado">Médico de confianza</label>'
                    +    '<input id="aliado" type="text" value="'+txt_aliado[i]+'" class="form-control" name="aliado" required>'
                    + '</div>'
                    ...
                    $(".modal-delete").append('<div class="modal fade delete" id="myModalDelete'+txt_id[i]+'" role="dialog">'
                    +    '<div class="modal-dialog">'
                    +    '<div class="modal-content">'
                ...
                $('.links-pags').html("<a href='/' class='link-nr'>Borrar</a>");                                                                        
            }
        })
    }
